          ...
          <div className="space-y-3">
            <div>
              ...
              <input
                ...
                required
                className="w-full px-3 py-3 rounded-lg border border-border bg-surface text-sm focus:outline-none focus:ring-2 focus:ring-primary/30 focus:border-primary"
              />
            </div>
            <div>
