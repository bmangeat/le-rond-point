  ...
  return (
    <div className="min-h-screen bg-background flex flex-col items-center justify-between px-7 py-10 text-center">
      ...
      <div className="flex-1 flex flex-col items-center justify-center gap-0">
        <Logo size={104} />
        <h1
          className="text-foreground mt-7"
          style={{ fontSize: 30, fontWeight: 700, letterSpacing: "-0.025em" }}
        >
          Le Rond Point
        </h1>
        <p className="text-muted-foreground mt-2.5 leading-relaxed max-w-[280px]" style={{ fontSize: 15.5 }}>
      ...
      <div className="w-full max-w-sm flex flex-col items-center gap-0">
        {errorMsg && (
          <div className="w-full mb-5 px-4 py-3 rounded-2xl bg-destructive/10 text-destructive text-sm">
            {errorMsg}
          </div>
        )}
        ...
        <p className="text-subtle mt-4" style={{ fontSize: 12.5 }}>
        ...
        {process.env.NODE_ENV === "development" && (
          <form
            ...
            className="w-full mt-8 border-t border-border pt-6"
          >
